...
CXXFLAGS = -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ \
		   ...
		   -pie -fPIE -Werror=vla -fsanitize=address,alignment,bool,bounds,enum,float-cast-overflow,$\
...
PROCFLAGS = $(CXXFLAGS) -I include -I include/spu
...
ASMEXECUTABLE = compile

ASMFLAGS = $(CXXFLAGS) -I include -I include/asm
...
asm:
	$(CXX) $(ASMSOURCES) -DASM $(ASMFLAGS) -o $(ASMEXECUTABLE)
